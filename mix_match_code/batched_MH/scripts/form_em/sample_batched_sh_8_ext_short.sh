...
--delta 0 \
--gamma 0 \
--data_name form_em_test_sh8_inf_len_fixed \
--disc_name  frm_roberta_ext_flip \
--disc_dir "cointegrated/roberta-base-formality" \
--data_path ../../data/form_em/test_sh_8_inf.txt \
--attr_path ../../data/form_em/test_sh_8_flip_inf.attr \
...
--delta 0 \
--gamma 0 \
--data_name form_em_test_sh8_inf \
--disc_name  frm_roberta_ext_flip \
--disc_dir "cointegrated/roberta-base-formality" \
--data_path ../../data/form_em/test_sh_8_inf.txt \
--attr_path ../../data/form_em/test_sh_8_flip_inf.attr \
